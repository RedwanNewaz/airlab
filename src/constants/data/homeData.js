    ...
    secondaryContent: [
      {
        header: "How it works",
        content:
          "Manipulator is a system designed to perform various tasks, such as picking and placing objects and navigating through environments, and performing tasks that require complex coordination.",
      },
      {
        header: "Applications",
        content:
          "Manuplators have the potential to revolutionize various industries, such as agriculture, construction, and transportation, by enabling safe and efficient delivery of goods, services, and information",
      },
    ],
    relatedResearch: [4],
